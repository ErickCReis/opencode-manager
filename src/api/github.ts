...
export const githubRouter = new Elysia()
  ...
  .post('/api/github/repos/:owner/:repo/branches', async ({ params, body }) => {
    try {
      const client = createGitHubClient(GITHUB_TOKEN)
  ...
  .post('/api/github/repos/:owner/:repo/pulls', async ({ params, body }) => {
    try {
      const client = createGitHubClient(GITHUB_TOKEN)
  ...
  .get('/api/github/repos/:owner/:repo/pulls', async ({ params, query }) => {
    try {
      const client = createGitHubClient(GITHUB_TOKEN)
